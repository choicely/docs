...
Automate and integrate with Choicely programmatically using the REST API.
...
<Card
  ...
  horizontal
>
  Manage apps, contests, shops, surveys, and more over HTTP with Bearer authentication.
</Card>
